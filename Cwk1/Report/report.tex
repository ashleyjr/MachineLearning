...
A low dimensional representation of the constraints held by DBSCAN is shown in Figure~\ref{fig:circles}.    % which contains eight points labelled \textbf{A} to \textbf{H}.
...
%Increasing $\epsilon$ will eventually merge these three possible clusters.
