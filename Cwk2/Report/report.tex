...
\lstinputlisting[label=lst:run.m,caption=run.m]{../SLP/run.m}
\lstinputlisting[label=lst:train.m,caption=train.m]{../SLP/train.m}
\lstinputlisting[label=lst:predict.m,caption=predict.m]{../SLP/predict.m}
\lstinputlisting[label=lst:featSelect.m,caption=featSelect.m]{../SLP/feat_select.m}
\end{appendix}
